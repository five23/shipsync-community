...
class IllApps_ZoneRates_Model_Resource_Zone_Alpha extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        if (empty($_FILES['groups']['tmp_name']['zonerates']['fields']['import_alpha']['value'])) {
            return $this;
        }

        $csvFile = $_FILES['groups']['tmp_name']['zonerates']['fields']['import_alpha']['value'];
...
/**
     ...
     *
     * @param array $data
     * @return Mage_Shipping_Model_Resource_Zone_Alpha
     */
    protected function _saveImportData(array $data)
    {
        if (!empty($data)) {
            $columns = array('zipcode', 'zone');
